...
module.exports.ThrowTerminator = ThrowTerminator

function TryCatchTerminator(tryblock, catchblock, node) {
  this.type = "TryCatchTerminator"
  this.try = tryblock
  this.catch = catchblock
  setNode(thisNode)
}
module.exports.TryCatchTerminator = TryCatchTerminator